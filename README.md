# Expo Video Asset Transporter Provided Demo

This App demonstrates how to use the `expo-video` asset transport provider API in combination with a local module.
...
- This demonstration purposes only.
...
- `modules/expo-video-dash-support-moule/expo-module.config.json`: declares the Apple module entry point
- `modules/expo-video-dash-support-moule/ios/ExpoVideoDashSupportModule.swift`: registers and unregisters the provider
- `modules/expo-video-dash-support-moule/ios/SegmentBaseDASHToHLSTransport.swift`: contains the demo DASH-to-HLS transport implementation
